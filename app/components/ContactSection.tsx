...
export function ContactSection() {
  ...
  return (
    <>
      {/* ── Top CTA banner ─────────────────────────────────────────── */}
      <AnimatedSection className="border-t border-black/5 bg-[#4A6CF7] rounded-4xl mx-[14px] max-w-5xl md:mx-auto" delay={0.05}>
        <section className="px-6 md:px-18 py-10 md:py-20 lg:max-w-7xl">
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            ...
            <a
              href="#contact"
              className="inline-flex h-11 shrink-0 items-center justify-center gap-2 rounded-full bg-white px-6 text-sm font-semibold text-blue-600 shadow-sm transition hover:-translate-y-0.5 hover:bg-blue-50"
            >
              Contact Us
            ...
            {highlights.map((h, i) => (
              <div key={h.label} className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1.5 text-sm leading-6 text-blue-100">{h.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <AnimatedSection className="bg-zinc-50" delay={0.05}>
        <section
          id="contact"
          className="mx-auto max-w-5xl px-4 py-20 md:px-4"
        >
          {/* Section header */}
              ...
              >
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      type="text"
                      placeholder="John"
                      className="rounded-xl border border-zinc-200 bg-zinc-50 px-4 py-3 text-sm text-zinc-900 outline-none placeholder:text-zinc-400 focus:border-blue-400 focus:bg-white focus:ring-2 focus:ring-blue-100 transition"
                    />
                  </div>
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-semibold uppercase tracking-wide text-zinc-500">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea
                    ...
                    className="resize-none rounded-xl border border-zinc-200 bg-zinc-50 px-4 py-3 text-sm text-zinc-900 outline-none placeholder:text-zinc-400 focus:border-blue-400 focus:bg-white focus:ring-2 focus:ring-blue-100 transition"
                  />
                </div>
                ...
                <div className="pt-2">
                  <button
                    type="submit"
                    disabled={!agreed}
                    className="inline-flex items-center gap-2 rounded-full px-8 py-3 text-sm font-semibold text-white shadow-md transition hover:-translate-y-0.5 hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40"
